...
entries.forEach(element => {
    ...
    results.push((rowIndex*8) + 1 * seatIndex);
});

var sortedResults = results.sort((a,b) => a-b);
for (var i = 1; i < sortedResults.length; i++) {
    if (sortedResults[i] - sortedResults[i - 1] != 1) {
        console.log('found discrepancy at index ', i, ' numbers ', sortedResults[i-1], sortedResults[i], sortedResults[i+1]);
    }
}
