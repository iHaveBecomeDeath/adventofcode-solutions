...
if (results.index1) {
    console.log("Found match in indexes", results.index1 + ", " + results.index2 + ", " + results.index3, "which gives us", results.value1 + " + " + results.value2 + " + " + results.value3 + " = " + (results.value1 * results.value2 * results.value3));
} else {
