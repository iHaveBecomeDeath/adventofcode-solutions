...
for (var i = 0; i < input.length; i++) {
    var idx = missingUntilTargetValueArray.indexOf(input[i]);
    if (idx != -1) {
        results = {
            index1: idx,
            index2: i,
...
if (results.index1) {
    console.log("Found match in indexes", results.index1 + ", " + results.index2, "which gives us", results.value1 + " + " + results.value2 + " = " + (results.value1 * results.value2));
} else {
